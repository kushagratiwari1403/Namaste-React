...
const Header = () => {
    return (
        <div id="header">
            <div id="logo">
                <img className="logo-img" src="https://media.istockphoto.com/id/1038355632/vector/hamburger-icon.jpg?s=612x612&w=0&k=20&c=0lwYqfJxkss5KKmDPAFZRJ9_2-z3h1tRAfFyAKpVEYU="></img>
            </div>
            <div id="nav-items">
                <ul>
                    <li>Home</li>
...
const restaurantsList = [
    {
        ...
        "analytics": {
            "context": "seo-data-031842af-83a9-4629-85a5-2fcc154adf29"
        },
        "cta": {
    ...
    return (
        <div className="footer">
            <div className="footer-logo">
                <img className="footerlogo-img" src="https://media.istockphoto.com/id/1038355632/vector/hamburger-icon.jpg?s=612x612&w=0&k=20&c=0lwYqfJxkss5KKmDPAFZRJ9_2-z3h1tRAfFyAKpVEYU="></img>
            </div>
